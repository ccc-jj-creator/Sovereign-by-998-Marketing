        ...
        <div className="max-w-7xl mx-auto">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center text-xs text-gray-600 mb-8">
                <div className="mb-4 md:mb-0 max-w-sm">
                    <p className="mb-2">&copy; 2024 998 Marketing LLC (dba Sovereign 998). All Rights Reserved.</p>
                    <p>Sovereign 998 is a real estate investment and buying company specializing in purchasing properties directly from homeowners.</p>
                </div>
                <div className="flex flex-wrap gap-x-8 gap-y-4 mt-4 md:mt-0">
            ...
            <div className="text-xs text-gray-700 pt-4 border-t border-white/5">
