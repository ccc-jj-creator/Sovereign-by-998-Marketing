                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4 border-t border-white/10">
                    ...
                    <div className="flex items-start space-x-3 pt-2">
                        ...
                        <label htmlFor="consent" className="text-[10px] text-gray-400 leading-tight cursor-pointer">
                            By checking this box, I agree to receive recurring automated marketing and informational SMS messages from 998 Marketing LLC (dba Sovereign 998) regarding my property inquiry and related real estate services. Consent is not a condition of purchase. Message frequency varies (up to 4 messages/month). Message and data rates may apply. Reply STOP to opt out or HELP for assistance. See <a href="https://sovereign998.app/privacy" target="_blank" rel="noopener noreferrer" className="text-wealth-gold hover:underline">Privacy Policy</a> and <a href="https://sovereign998.app/sms-terms" target="_blank" rel="noopener noreferrer" className="text-wealth-gold hover:underline">SMS Terms</a>.
                        </label>
                    </div>
